                            ...
                            <div className="row">
                                <div className="col-xl-3 col-lg-6 col-sm-12 col-md-6 pd_zero border_r">
                                    <div className="icon_box_all style_six version_2">
                                        <div className="icon_content">
                                            <div className="icon">
                                                <img src="/assets/images/about/about-1-1.png" className="img-fluid svg_image" alt="icon png"/>
                                            </div>
                                            <div className="text_box">
                                                <h2><a href="#" target="_blank" rel="nofollow">Efficiency & Expertise</a></h2>
                                                <p>Dedicated teams delivering accurate results.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div className="col-xl-3 col-lg-6 col-sm-12 col-md-6 pd_zero border_r">
                                    <div className="icon_box_all style_six version_2">
                                        <div className="icon_content">
                                            <div className="icon">
                                                <img src="/assets/images/about/about-2.jpg" className="img-fluid svg_image" alt="icon png"/>
                                            </div>
                                            <div className="text_box">
                                                <h2><a href="#" target="_blank" rel="nofollow">Technology-Driven Processes</a></h2>
                                                <p>Use of Xero, TaxCalc, and cloud-based solutions.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div className="col-xl-3 col-lg-6 col-sm-12 col-md-6 pd_zero border_r">
                                    <div className="icon_box_all style_six version_2">
                                        <div className="icon_content">
                                            <div className="icon">
                                                <img src="/assets/images/about/about-3.jpg" className="img-fluid svg_image" alt="icon png"/>
                                            </div>
                                            <div className="text_box">
                                                <h2><a href="#" target="_blank" rel="nofollow"> Cost Savings</a></h2>
                                                <p>Streamlined operations without the overhead costs.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div className="col-xl-3 col-lg-6 col-sm-12 col-md-6 pd_zero">
                                    <div className="icon_box_all style_six version_2">
                                        <div className="icon_content">
                                            <div className="icon">
                                                <img src="/assets/images/about/about-4.jpg" className="img-fluid svg_image" alt="icon png"/>
                                            </div>
                                            <div className="text_box">
                                                <h2><a href="#" target="_blank" rel="nofollow">Client-Centric Approach</a>
                                                </h2>
                                                <p>Customized services tailored for UK businesses.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
